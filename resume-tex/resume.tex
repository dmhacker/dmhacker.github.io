...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Experience}
\runsubsection{MyGolfFaves}\descript{| Application Developer}\hfill \location{June 2017 – Sep 2017}
\begin{tightemize}
  \item Using React Native, created iOS and Android apps for MyGolfFaves, a golfing rewards/discounts company
\end{tightemize}
\sectionsep
\runsubsection{Blinks}\descript{| Full Stack Developer}\hfill \location{July 2016 – Jan 2017}
\begin{tightemize}
...
\end{tightemize}
\sectionsep
\runsubsection{IndieU}\descript{| Full Stack Developer}\hfill \location{Mar 2016 – Aug 2016}
\begin{tightemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Awards}
\runsubsection{\large{1st Place @ Startup Weekend Conejo Valley 2017}} \descript{Mar 2017 | Camarillo, CA} \\
...
\sectionsep
\runsubsection{\large{Honorable Mention @ SIAM M3 Challenge}} \descript{Mar 2017 | Westlake Village, CA} \\
